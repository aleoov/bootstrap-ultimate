...
if ( ! function_exists( 'optionsframework_uploader_custom' ) ) :

function optionsframework_uploader_custom( $_id, $_value, $_desc = '', $_name = '' ) {
...
add_action( 'admin_enqueue_scripts', 'optionsframework_media_scripts_custom' );

function optionsframework_media_scripts_custom() {
	...
	if ( function_exists( 'wp_enqueue_media' ) )
		wp_enqueue_media();
	wp_register_script( 'of-media-uploader', get_template_directory_uri() . '/panel/of/js/media-uploader.js', array( 'jquery' ) );
